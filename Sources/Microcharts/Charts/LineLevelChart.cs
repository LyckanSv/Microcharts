...
{
    public class LineLevelChart : PointChart
    {
        #region Constructors
        ...
        private Dictionary<ChartSerieLevel, List<SKPoint>> pointsPerSerie = new Dictionary<ChartSerieLevel, List<SKPoint>>();
        /// <summary>
        ...
        public override void DrawContent(SKCanvas canvas, int width, int height)
        {
            ...
            foreach (var s in Series)
                pointsPerSerie.Add((ChartSerieLevel)s, new List<SKPoint>());
        ...
        protected override void DrawBar(ChartSerie serie, SKCanvas canvas, float headerHeight, float itemX, SKSize itemSize, SKSize barSize, float origin, float barX, float barY, SKColor color)
        {
            ...
            pointsPerSerie[(ChartSerieLevel)serie].Add(point);
